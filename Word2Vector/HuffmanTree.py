...
# 统计词频
# WordFrequently = StaticalWordFrequently()
# PrintWordFrequently(WordFrequently, "E:\\WordFrequently.txt")
# 生成哈夫曼树和哈夫曼编码
# WordFrequentlyDict = loadWordFrequently("E:\\WordFrequently2.txt")
# HuffmanTree = createHuffmanTree(WordFrequentlyDict)
# PrintHuffmanTree(HuffmanTree)
# getHuffmanCode(HuffmanTree, len(WordFrequentlyDict), "E:\\HuffmanNode.txt")
