...
def get_RecommandList(User_Behavior_Dict, User_Similary_Dict, answer_id_dict):
...
if __name__ == '__main__':
    ...
    User_Recommond_Dict = get_RecommandList(User_Behavior_Dict, User_Similary_Dict, answer_id_dict)
